...
const Landing = ({
    ...
    return (
        <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="mx-auto p-10 w-full h-full max-w-6xl flex flex-col justify-center items-center lg:p-0 lg:flex-row lg:justify-between"
        >
            <motion.div
                initial="initial"
                whileInView="animate"
            ...
            >
                ...
                <p className="text-base md:text-[18px] text-center leading-none mb-5 ">
            ...
            <motion.div
                ...
                transition={{ delay: 0.5, type: "easeOut" }}
                viewport={{ amount: 0.5 }}
                exit={{ opacity: 0 }}
            >
                <motion.div
